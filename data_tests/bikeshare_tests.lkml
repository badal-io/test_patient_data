include: "../Explores/bikeshare_info.explore.lkml"

test: bikeshare_station_ids_not_null {
  ...
  assert: start_station_id_not_null {
    expression: NOT is_null(${bikeshare_trips.start_station_id}) AND NOT is_null(${bikeshare_trips.end_station_id}) ;;
  }
}
