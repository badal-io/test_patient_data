include: "../Explores/inpatient_outpatient.explore.lkml"
...
test: outpatient_services_by_city_greater_than_1000 {
  explore_source: inpatient_outpatient {
    ...
    filters: [outpatient_charges_2013.outpatient_services: ">1000"]
  }
