# Data tests for Explore 2: Bikeshare Info

# Test 1: Check that start_station_id and end_station_id in bikeshare_trips view are not NULLs
...
test: bikeshare_end_station_id_not_null {
  ...
  assert: end_station_id_not_null {
